...
import com.example.spring5petclinic.repositories.SpecialtyRepository;
...
public class SpecialitySdJpaService implements SpecialtyService {
  ...
  @Override public Set<Specialty> findAll() {
  ...
  @Override public Specialty findById(Long id) {
    return specialtyRepository.findById(id).orElse(null);
  }

  @Override public Specialty save(Specialty specialty) {
